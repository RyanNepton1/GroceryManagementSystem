...
public class GroceryManagementSystem
{
  ...
  /* Code from template association_AddManyToOne */
  public Order addOrder(Date aDatePlaced, String aErrorMsg, boolean aHasErrorMsg, int aPointsUsed, Order.DeliveryDeadline aDeadline, Customer aOrderPlacer)
  {
    return new Order(aDatePlaced, aErrorMsg, aHasErrorMsg, aPointsUsed, aDeadline, this, aOrderPlacer);
  }
