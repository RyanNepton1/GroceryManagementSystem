...
public class Customer extends UserRole
{
  ...
  public Order addOrdersPlaced(Date aDatePlaced, String aErrorMsg, boolean aHasErrorMsg, int aPointsUsed, Order.DeliveryDeadline aDeadline, GroceryManagementSystem aGroceryManagementSystem)
  {
    return new Order(aDatePlaced, aErrorMsg, aHasErrorMsg, aPointsUsed, aDeadline, aGroceryManagementSystem, this);
  }
